#ifndef ETEST_APP_MODERN_CLOCK_RENDERER_H_
#define ETEST_APP_MODERN_CLOCK_RENDERER_H_

#include "clock_renderer.h"

class ModernClockRenderer : public IClockRenderer {
 public:
...
#endif  // ETEST_APP_MODERN_CLOCK_RENDERER_H_
